...
const smartPositionResolve = (rectParent: DOMRect, rectDropDown: DOMRect, priority: DropdownPosition[]): any => {
...
export const Dropdown = ({
    ...
    useEffect(() => {
        const onResize = () => {
            if (!show || !ddRef.current || !parent.current) {
                return;
            }

            const dropdownElement = ddRef.current;
