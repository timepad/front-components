...
// import {Userpic} from '../button';

import IconTicket from '../../assets/svg/24/icon-ticket-24.svg';
import IconBookmark from '../../assets/svg/24/icon-bookmark-24.svg';
import IconLogout from '../../assets/svg/24/icon-logout-24.svg';
import IconEdit from '../../assets/svg/24/icon-edit-24.svg';

// import StoryRouter from 'storybook-react-router';
import {action} from '@storybook/addon-actions';

import {cities} from './stories/cities';
